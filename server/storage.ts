...
class DatabaseStorage implements IStorage {
  ...
  private async initializeSampleData() {
    ...
    const project1 = await this.createProject({
      ...
      startDate: "2024-03-01",
      endDate: "2024-03-25",
      defaultSuperintendent: 1,
      defaultProjectManager: 1
    });
    ...
    // Create sample locations
    const location1 = await this.createLocation({
      name: "Main St Bridge - North Section",
    ...
    const location2 = await this.createLocation({
      name: "City Hall - East Wing",
    ...
    const task3 = await this.createTask({
      taskId: "PRJ-2024-002_EastWing_Demo_Day2",
      locationId: location2.locationId,
      taskType: "Demo/Ex",
      name: "Demo/Ex Base Grade",
      taskDate: "2025-08-09",
      startDate: "2025-08-09",
      finishDate: "2025-08-09",
      costCode: "DEMO/EX",
      superintendentId: 1,
      foremanId: 2,
      scheduledHours: "32",
      startTime: "08:00",
      finishTime: "17:00",
      workDescription: "Continue demolition and base preparation work.",
      notes: "Focus on eastern section today",
      status: "upcoming",
      order: 1,
      dependentOnPrevious: true
    });
    ...
    // Create sample budget items for location 1
    await this.createBudgetLineItem({
      locationId: location1.id,
      lineItemNumber: "1001",
      lineItemName: "Concrete - Bridge Deck",
      ...
      subCategoryCode: "CONCRETE",
      assembly: "Bridge Deck Pour",
      notes: "High-strength concrete mix required"
    });

    await this.createBudgetLineItem({
      locationId: location1.id,
      lineItemNumber: "1002",
      lineItemName: "Demo/Ex + Base/Grading",
      unconvertedUnitOfMeasure: "SY",
      unconvertedQty: "200",
      actualQty: "0",
      unitCost: "125.00",
      unitTotal: "25000.00",
      convertedQty: "200",
      convertedUnitOfMeasure: "SY",
      productionRate: "8.0",
      hours: "25",
      billing: "25000.00",
      costCode: "DEMO/EX",
      phaseCode: "BASE/GRADING",
      categoryCode: "DEMO",
      subCategoryCode: "DEMO",
      assembly: "Site Preparation",
      notes: "Combined demolition and base preparation"
    });
...
function initializeStorage(): IStorage {
  ...
  try {
    console.log("Initializing persistent PostgreSQL storage...");
