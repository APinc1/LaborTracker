...
export default function EditTaskModal({ isOpen, onClose, task, onTaskUpdate, locationTasks = [] }: EditTaskModalProps) {
  ...
  // Unit of measure options - limited to CY and TONS for production
  const unitOfMeasureOptions = defaultUnitOfMeasureOptions;
  ...
  return (
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="sticky -top-6 z-10 bg-background pt-6 pb-4 -mx-6 px-6 border-b">
                                ...
                                return (
                                  <div key={liq.budgetLineItemId} className="flex items-center gap-2">
                                    <div className="flex-1 text-sm">
                                      <span className="text-gray-600 mr-1">{item.lineItemNumber} -</span>
