              ...
              onClick={async () => {
                ...
                if (task.linkedTaskGroup && existingTasks) {
                  ...
                  try {
                    ...
                    // Unlinking complete - manual date calculation already handled all dates correctly
                    console.log('🔗 Unlinking complete - all dates calculated and updated correctly');
